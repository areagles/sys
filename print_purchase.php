...
// جلب البيانات
$sql = "SELECT p.*, s.name as sup_name, s.phone as sup_phone, s.address as sup_address 
...
<head>
    <meta charset="UTF-8">
    <title>فاتورة مشتريات #<?php echo $id; ?></title>
...
<body>
    ...
    <div class="no-print" style="position:fixed; top:20px; left:20px; z-index:999;">
        ...
        <a href="purchase_invoices.php" style="padding:12px 25px; background:#333; color:#fff; text-decoration:none; margin-right:10px; border-radius:5px; display:inline-block;">
            رجوع
        </a>
    </div>
    ...
    <div class="invoice-box">
        <div class="header">
            ...
            <div class="invoice-title">
                ...
                <div class="status">#<?php echo str_pad($inv['id'], 5, '0', STR_PAD_LEFT); ?></div>
            </div>
        </div>
        ...
        <div class="footer">
            <p>تم إصدار هذه الفاتورة إلكترونياً من نظام Arab Eagles للإدارة المالية.</p>
